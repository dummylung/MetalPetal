...
struct MTIMultilayerBrushCompositingLayerShadingParameters {
    ...
    vector_float2 materialMaskOffsetJitter;
    ...
    vector_float2 startLayerSize;
    vector_float2 lastPosition;
