...
- (instancetype)initWithContent:(MTIImage *)content component:(MTIColorComponent)component mode:(MTIMaskMode)mode {
    return [self initWithContent:content component:component mode:mode type:MTIMaskTypeMoving movement:0 scale:1.0 zoom:0 rotation:0 depth:1 offsetJitter:CGPointZero blendMode:MTIBlendModeMultiply position:CGPointZero size:CGSizeZero];
}
